...
const THANK_U_NEXT: Record = {
  ...
  genre: Genres.POP,
  producers: [ROSTER_MEMBERS.TOMMY_BROWN],
  writers: [ROSTER_MEMBERS.TOMMY_BROWN],
...
const JUSTICE: Record = {
  ...
  genre: Genres.POP,
  producers: [ROSTER_MEMBERS.TOMMY_BROWN, ROSTER_MEMBERS.MR_FRANKS],
  writers: [ROSTER_MEMBERS.TOMMY_BROWN, ROSTER_MEMBERS.MR_FRANKS],
...
const FUTURE_NOSTALIGA: Record = {
  ...
  genre: Genres.POP,
  producers: [ROSTER_MEMBERS.TOMMY_BROWN],
  writers: [ROSTER_MEMBERS.MELANIE_JOY_FONTANA],
...
const DAWN_FM: Record = {
  ...
  artist: 'The Weeknd',
  genre: Genres.POP,
  producers: [ROSTER_MEMBERS.PETER_LEE_JOHNSON, ROSTER_MEMBERS.TOMMY_BROWN],
  writers: [],
...
const CERTIFIED_LOVER_BOY: Record = {
  ...
  artist: 'Drake',
  genre: Genres.HIPHOP,
  producers: [ROSTER_MEMBERS.PETER_LEE_JOHNSON],
  writers: [],
...
const UN_VERANO_SIN_TI: Record = {
  ...
  producers: [ROSTER_MEMBERS.BASS_CHARITY],
  writers: [ROSTER_MEMBERS.BASS_CHARITY],
